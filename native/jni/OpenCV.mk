...
OPENCV_MODULES:=gapi stitching aruco barcode bgsegm bioinspired ccalib dnn_objdetect dnn_superres dpm face fuzzy hfs img_hash intensity_transform line_descriptor mcc quality rapid reg rgbd saliency stereo structured_light phase_unwrapping superres optflow surface_matching tracking highgui datasets text plot videostab videoio wechat_qrcode xfeatures2d shape ml ximgproc video dnn xobjdetect objdetect calib3d imgcodecs features2d flann xphoto photo imgproc core
